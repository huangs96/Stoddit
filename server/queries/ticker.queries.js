...
const addTimeIntervalToTicker = 'INSERT INTO ticker_time_interval (chatroom_id, name, symbol, ticker_id, current_price, high_price, low_price, recommendation, volume, date_time) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9 now());';

module.exports = {
  getAllTickers,
  getTickersByChatroomID,
  addTimeIntervalToTicker
};